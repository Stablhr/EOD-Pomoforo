  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <input
        ...
        min="0"
        placeholder="0"
        className="w-20 px-3 py-2 border border-stone-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 text-center"
      />
